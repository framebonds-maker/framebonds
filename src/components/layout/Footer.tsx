...
export function Footer() {
  ...
  return (
    <footer className="border-t border-divider bg-canvas">
      <Container width="wide" className="pt-20 pb-10 md:pt-28">
        {/* Closing invitation */}
        <div className="flex flex-col items-start justify-between gap-10 border-b border-divider pb-16 md:flex-row md:items-end md:pb-20">
          <div className="max-w-xl">
            <p className="font-display text-heading-l font-medium text-ink md:text-heading-xl">
              Let's create something
              <br />
              worth remembering<span className="text-accent">.</span>
            </p>
          </div>
